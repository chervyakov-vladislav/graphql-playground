...
function GraphLogoBlock({ children }: Props) {
  return (
    <div
      className={
        'bg-color-light-gray rounded-xl w-[30%] md:min-h-[480px] min-w-[450px] max-w-[450px] pt-[15px] pb-[15px] max-[500px]:min-w-[90%]'
      }
    >
      <div className={'pl-[3.7%] pr-[3.7%] text-color-bright-black text-center'}>
        <div className={'flex justify-center items-center h-[50px] md:mt-12 md:mb-11'}>
